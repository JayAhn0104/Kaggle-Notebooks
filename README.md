...
| Competition / Data                                                                                       | Problem Type          | Notebook (colab) |
|----------------------------------------------------------------------------------------------------------|-----------------------|------------------|
| [Riiid Answer Correctness Prediction](https://www.kaggle.com/c/riiid-test-answer-prediction)                            | Knowledge Tracing (user - question answer correctness prediction)  | [Riiid_DKT.ipynb](https://colab.research.google.com/drive/1yI87_Zai_DJumJGqFjUEmdt7dJa8nrXY?usp=sharing) |
